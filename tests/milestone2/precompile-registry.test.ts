...
describe('Precompile Registry', () => {
  ...
  describe('HardhatArbitrumPatch Integration', () => {
    ...
    it('should register handlers on initialization', () => {
      ...
      expect(patch.hasHandler('0x0000000000000000000000000000000000000064')).to.be.true; // ArbSys
      expect(patch.hasHandler('0x000000000000000000000000000000000000006C')).to.be.true; // ArbGasInfo
    ...
    it('should be disabled when configured', () => {
      ...
      expect(patch.hasHandler('0x0000000000000000000000000000000000000064')).to.be.false;
  ...
  describe('Configuration Validation', () => {
    it('should handle BigInt configuration values', () => {
      ...
      expect(retrievedConfig.gasPriceComponents!.l2BaseFee).to.equal(BigInt(2e9));
      expect(retrievedConfig.gasPriceComponents!.l1CalldataCost).to.equal(BigInt(20));
      expect(retrievedConfig.gasPriceComponents!.congestionFee).to.equal(BigInt(1e8));
    });
  });
});
