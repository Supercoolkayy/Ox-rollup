...
runTest('File Content Validation', () => {
  ...
  const registryContent = fs.readFileSync('src/hardhat-patch/precompiles/registry.ts', 'utf8');
  ...
  const arbSysContent = fs.readFileSync('src/hardhat-patch/precompiles/arbSys.ts', 'utf8');
  ...
  const arbGasInfoContent = fs.readFileSync('src/hardhat-patch/precompiles/arbGasInfo.ts', 'utf8');
...
runTest('Address Constants', () => {
  ...
  if (!arbGasInfoContent.includes('0x000000000000000000000000000000000000006C')) {
